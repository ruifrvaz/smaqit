...
- Performed a comprehensive repo-wide audit for downstream project names: `iodis-crm-poc` (19 instances across 4 files), `fashion-app-poc` (1 instance in 1 file). `areaoffice-poc`, `assistente-escolas` were already clean.
