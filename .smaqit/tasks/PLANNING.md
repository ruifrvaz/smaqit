...
|----|-------|--------|----------|
| 111 | Design Sequence Diagram Has No Deterministic Enforcement, and a Layer-Mismatch Bug Rejects the Established Convention That Would Link One | new | High |
...
| 086 | Reconcile a Downstream Python/FastAPI + Next.js Deploy Skill Into Canonical smaqit |
...
| 064 | Complete Level 0 Principle Cleanup | Superseded by smaqit-adk extraction. Level 0 framework principles and L0/L1/L2 agent compilation chain migrated to smaqit-adk. |
